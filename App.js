...
export default function App() {
  ...
  let inicialMensagem = ' " Mensagem do Biscoito " ';
  const [img, setImg]= useState(require('../biscoito/src/biscoito.png'));
  const [textBiscoito, setTextBiscoito] = useState(inicialMensagem);
  ...
  function abrirBiscoito(){
    setImg(require('../biscoito/src/biscoitoAberto.png'));
    let mensagemAberta = Math.floor(Math.random() * mensagem.length);
    setTextBiscoito( ' " ' + mensagem[mensagemAberta] + ' " ');
    //console.log(mensagem[mensagemAberta])
  };

  function fecharBiscoito(){
    setImg(require('../biscoito/src/biscoito.png'));
    setTextBiscoito('" Mensagem do Biscoito "');
  }
  ...
  return (
    <View style={style.container}>
      ...
      <Text style={style.textBiscoito}>{textBiscoito}</Text>

      <TouchableOpacity style={style.btn} onPress={abrirBiscoito} >
        <View style={style.areaBtn}>
          <Text style={style.textBtn}>Abrir Biscoito</Text>
        </View>
      </TouchableOpacity>

      <TouchableOpacity style={[style.btn, {borderColor:'black'}]} onPress={fecharBiscoito}>
        <View style={style.areaBtn}>
          <Text style={[style.textBtn, {color:'black',}]}>Fechar Biscoito</Text>
        </View>
      </TouchableOpacity>
